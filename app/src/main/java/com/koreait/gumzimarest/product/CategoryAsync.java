...
public class CategoryAsync extends AsyncTask<String, Void, String> {
    String TAG=this.getClass().getName();
    CategoryFragment categoryFragment;
    int topcategory_id;

    public CategoryAsync(CategoryFragment categoryFragment, int topcategory_id){
    ...
    protected void onPostExecute(String data) {
        try {
            ...
            for(int i=0;i<jsonArray.length();i++){
                ...
                CategoryImageDownLoaderAsync downAsync = new CategoryImageDownLoaderAsync(product, categoryFragment);
